 ...
 * 
 * An ITObject corresponding to a track will always have a valid track and track
 * database ID. These IDs will be zero for a source or playlist.
 * 
 ...
 * 
 * An ITObject also has a 64-bit persistent ID which can be used to identify the
 * ITObject across multiple invocations of iTunes.
 * 
...
public class ITObject {
	 ...
	 * 
	 * @return Returns the ID that identifies the track, independent of its
	 *         playlist.
	 */
