...
public class ITSourceCollection {
	 ...
	 * 
	 * @param index
	 *            Index of the source to retrieve, must be less than or equal to
	 *            <code>ITSourceCollection.getCount()</code>.
	 * @return Returns an ITSource object corresponding to the given index. Will
	 *         be set to NULL if no source could be retrieved.
	 */
	 ...
	 * @return Returns an ITSource object with the specified persistent ID. Will
	 *         be set to NULL if no source could be retrieved.
	 */
