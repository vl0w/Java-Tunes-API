 ...
 * implements <code>iTunesEventsInterface</code>. To receive events, create a
 * class that implements the interface, and then use
...
public class iTunesEvents {
	...
	public void OnCOMCallsDisabledEvent(Variant[] args) {
		ITCOMDisabledReason reason = ITCOMDisabledReason.values()[args[0]
				.getInt()];
