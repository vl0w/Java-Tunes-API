...
public class ITURLTrack extends ITTrack {
	 ...
	 * 
	 * @param description
	 *            The new description for the track.
	 */
	 ...
	 *            The new long description for the track.
	 */
	 ...
	 * 
	 * @return Returns the album rating of the album that this track belongs to
	 *         (0 to 100).
	 */
	 ...
	 * 
	 * @param albumRating
	 *            The new album rating of the album that this track belongs to
	 *            (0 to 100). If rating is outside this range, it will be
	 *            pinned.
	 */
	...
	public ITRatingKind getAlbumRatingKind() {
		return ITRatingKind.values()[Dispatch.get(object, "AlbumRatingKind")
				.getInt()];
	}
	...
	public ITRatingKind getRatingKind() {
		return ITRatingKind.values()[Dispatch.get(object, "RatingKind")
				.getInt()];
	}
