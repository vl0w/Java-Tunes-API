...
/**
 * Represents an entry in the Source list (music library, CD, device, etc.). You
 * can retrieve all the sources using <code>iTunes.getSources()</code>.
 * 
...
public class ITSource extends ITObject {
	...
	/**
	 * Returns a collection containing the playlists in this source. The
	 * source's primary playlist is always the first playlist in the collection.
	 * 
