...
public class ITPlaylist extends ITObject {
	 ...
	 *            If true, display the print dialog.
	 * @param printKind
	 *            The printout kind.
	 * @param theme
	 *            The name of the theme to use. This corresponds to the name of
	 *            a Theme combo box item in the print dialog for the specified
	 *            printKind (e.g. "Track length"). This string cannot be longer
	 *            than 255 characters, but it may be empty.
	 */
	public void print(boolean showPrintDialog, ITPlaylistPrintKind printKind,
			String theme) {
		Dispatch.call(object, "Print", showPrintDialog, printKind.ordinal(),
				theme);
	}
	 ...
	 * 
	 * @param searchText
	 *            The text to search for. This string cannot be longer than 255
	 *            chracters.
	 * @param searchFields
	 *            Specifies which fields of each track should be searched for
	 *            searchText.
	 * @return Collection of IITTrack objects. This will be NULL if no tracks
	 *         meet the search criteria.
	 */
	public ITTrackCollection search(String searchText,
			ITPlaylistSearchField searchFields) {
		Dispatch collection = Dispatch.call(object, "Search", searchText,
				searchFields.ordinal()).getDispatch();
	 ...
	 * 
	 * @return Returns the total length of all songs in the object (in seconds).
	 */
	 ...
	 * 
	 * @param shouldShuffle
	 *            True if songs in the object should be played in random order.
	 */
	...
	public ITPlaylistRepeatMode getSongRepeat() {
		return ITPlaylistRepeatMode.values()[Dispatch.get(object, "SongRepeat")
				.getInt()];
	}
	 ...
	 * 
	 * @return Returns the total length of all songs in the object (in MM:SS
	 *         format).
	 */
