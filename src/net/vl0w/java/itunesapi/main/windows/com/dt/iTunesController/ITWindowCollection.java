 ...
 * 
 * You can retrieve all the windows using <code>iTunes.getWindows()</code>.
 * 
...
public class ITWindowCollection {
	 ...
	 * 
	 * @param index
	 *            Index of the playlist to retrieve, must be less than or equal
	 *            to <code>ITWindowCollection.getCount()</code>.
	 * @return Returns an ITWindow object corresponding to the given index. Will
	 *         be set to NULL if no playlist could be retrieved.
	 */
	 ...
	 * 
	 * @param name
	 *            The name of the window to retrieve.
	 * @return Returns an ITWindow object corresponding to the given index. Will
	 *         be set to NULL if no ITWindow could be retrieved.
	 */
