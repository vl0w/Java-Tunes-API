...
public class ITTrack extends ITObject {
	 ...
	 * 
	 * @param album
	 *            The new name of the album containing the object.
	 */
	 ...
	 * 
	 * @param artist
	 *            The new artist/source of the object.
	 */
	 ...
	 *            The new tempo of the object (in beats per minute).
	 */
	 ...
	 * 
	 * @param comment
	 *            The new freeform notes about the object.
	 */
	 ...
	 * 
	 * @param isCompilation
	 *            True if this object should be from a compilation album.
	 */
	 ...
	 * 
	 * @param composer
	 *            The new composer of the object.
	 */
	 ...
	 * 
	 * @param discCount
	 *            The new total number of discs in the source album.
	 */
	 ...
	 * 
	 * @param discNumber
	 *            The new index of the disc containing the object on the source
	 *            album.
	 */
	 ...
	 *            True if the object should be checked for playback.
	 */
	 ...
	 * 
	 * @param eq
	 *            The new name of the EQ preset of the object.
	 */
	 ...
	 * 
	 * @param finish
	 *            The new stop time of the object (in seconds).
	 */
	...
	/**
	 * Set the grouping (piece) of the object. Generally used to denote
	 * movements within classical work.
	 * 
	 * @param grouping
	 *            The new grouping (piece) of the object.
	 */
	...
	/**
	 * Returns the grouping (piece) of the object. Generally used to denote
	 * movements within classical work.
	 * 
	 ...
	 * 
	 * @return Returns the text description of the object (e.g.
	 *         "AAC audio file").
	 */
	 ...
	 * 
	 * @param playedCount
	 *            The new number of times the object has been played.
	 */
	 ...
	 * set if the object is not playable (e.g. a PDF file). A value of zero
	 * means no played date.
	 * 
	 * @param playedDate
	 *            The new date and time the object was last played.
	 */
	...
	/**
	 * Returns the date and time the object was last played. A value of zero
	 * means no played date.
	 * 
	 ...
	 * (1-based). You can pass this index to
	 * IITTrackCollection::ItemByPlayOrder() for the collection returned by
	 * ITPlaylist::Tracks() to retrieve an ITTrack object corresponding to this
	 * object.
	 * 
	...
	/**
	 * Set the rating of the object (0 to 100). If the object rating is set to
	 * 0, it will be computed based on the album rating.
	 * 
	 * @param rating
	 *            The new rating of the object (0 to 100).
	 */
	...
	/**
	 * Returns the rating of the object (0 to 100). If the object rating has
	 * never been set, or has been set to 0, it will be computed based on the
	 * album rating.
	 * 
	 ...
	 * 
	 * @param start
	 *            The new start time of the object (in seconds).
	 */
	 ...
	 * 
	 * @param trackCount
	 *            The new total number of tracks on the source album.
	 */
	 ...
	 * 
	 * @param trackNumber
	 *            The new index of the object on the source album.
	 */
	 ...
	 *            Set the relative volume adjustment of the object (-100% to
	 *            100%).
	 */
	 ...
	 * 
	 * @return Returns the relative volume adjustment of the object (-100% to
	 *         100%).
	 */
	 ...
	 * 
	 * @param year
	 *            The new year the object was recorded/released.
	 */
