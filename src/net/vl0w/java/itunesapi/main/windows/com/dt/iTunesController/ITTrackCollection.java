...
public class ITTrackCollection {
	 ...
	 * 
	 * @param index
	 *            Index of the track to retrieve, must be less than or equal to
	 *            <code>ITTrackCollection.getCount()</code>.
	 * @return Returns an ITTrack object corresponding to the given index. Will
	 *         be set to NULL if no track could be retrieved.
	 */
	...
	public ITTrack getItemByPlayOrder(int index) {
		Dispatch item = Dispatch.call(object, "ItemByPlayOrder", index)
				.toDispatch();
	 ...
	 * 
	 * @param name
	 *            The name of the track to retrieve.
	 * @return Returns an ITTrack object corresponding to the given index. Will
	 *         be set to NULL if no track could be retrieved.
	 */
	 ...
	 * @return Returns an ITTrack object with the specified persistent ID. Will
	 *         be set to NULL if no track could be retrieved.
	 */
	public ITTrack getItemByPersistentID(int highID, int lowID) {
		Dispatch item = Dispatch.call(object, "ItemByPersistentID", highID,
				lowID).toDispatch();
		return new ITTrack(item);
	}
