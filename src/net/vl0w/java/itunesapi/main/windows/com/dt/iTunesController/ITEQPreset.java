...
/**
 * Represents an equalizer preset. You can retrieve or set the currently
 * selected EQ preset using the <code>iTunes.getCurrentEQPreset()<code> method.
 * 
...
public class ITEQPreset {
	 ...
	 * 
	 * @param level
	 *            The new equalizer preamp level (-12.0 db to +12.0 db).
	 */
	 ...
	 * 
	 * @param level
	 *            The new equalizer 32Hz level (-12.0 db to +12.0db).
	 */
	 ...
	 * 
	 * @param level
	 *            The new equalizer 64Hz level (-12.0 db to +12.0db).
	 */
	 ...
	 * 
	 * @param level
	 *            The new equalizer 125Hz level (-12.0 db to +12.0db).
	 */
	 ...
	 * 
	 * @param level
	 *            The new equalizer 250Hz level (-12.0 db to +12.0db).
	 */
	 ...
	 * 
	 * @param level
	 *            The new equalizer 500Hz level (-12.0 db to +12.0db).
	 */
	 ...
	 * 
	 * @param level
	 *            The new equalizer 1KHz level (-12.0 db to +12.0db).
	 */
	 ...
	 * 
	 * @param level
	 *            The new equalizer 2KHz level (-12.0 db to +12.0db).
	 */
	 ...
	 * 
	 * @param level
	 *            The new equalizer 4KHz level (-12.0 db to +12.0db).
	 */
	 ...
	 * 
	 * @param level
	 *            The new equalizer 8KHz level (-12.0 db to +12.0db).
	 */
	 ...
	 * 
	 * @param level
	 *            The new equalizer 16KHz level (-12.0 db to +12.0db).
	 */
	...
	/**
	 * Delete this EQ Preset. Any EQ preset can be deleted, including built-in
	 * presets, except for the Manual preset.
	 * 
	 * @param updateAllTracks
	 *            If true, any tracks that use this EQ preet will be set to have
	 *            no assigned EQ preset.
	 */
	...
	/**
	 * Rename this EQ Preset. The name of any EQ preset can be changed,
	 * including built-in presets, except for the Manual preset. EQ preset names
	 * cannot start with leading spaces. If you specify a name that starts with
	 * leading spaces they will be stripped out.
	 * 
	 * @param updateAllTracks
	 *            If true, any tracks that use this EQ preet will be updated
	 *            with the new preset name.
	 */
